...
function Products() {
  ...
  const handleTambahSubmit = async (e) => {
    ...
    if (description && !/^[A-Za-z0-9\s]+$/.test(description))
      newErrors.description = "Deskripsi hanya boleh alfanumerik.";
                    ...
                    <div className="modal-content p-3">
                      <form onSubmit={(e) => handleUpdateSubmit(e, p.id)}>
                        ...
                        <div className="input-field mb-2">
                          ...
                          />
                          {updateErrors.name && (
                            <small className="text-danger">{updateErrors.name}</small>
                          )}
                        </div>
                        <div className="input-field mb-2">
                          <label>Harga</label>
                          ...
                          />
                          {updateErrors.price && (
                            <small className="text-danger">{updateErrors.price}</small>
                          )}
                        </div>
                        <div className="input-field mb-2">
                          <label>Stok</label>
                          ...
                          />
                          {updateErrors.stock && (
                            <small className="text-danger">{updateErrors.stock}</small>
                          )}
                        </div>
                        <div className="input-field mb-2">
