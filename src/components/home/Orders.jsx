            ...
            <div className="modal-body">
              <div className="row g-3">
                <div className="col-md-6">
                  ...
                  <input type="text" className="form-control" name="product_id" value={formData.product_id} onChange={handleChange} required />
                </div>
                <div className="col-md-6">
                ...
                <div className="col-12">
                  ...
                  <textarea className="form-control" name="alamat" value={formData.alamat} onChange={handleChange} required></textarea>
                </div>
                <div className="col-md-6">
                  <label className="form-label">Kecamatan</label>
                  <select className="form-select" name="kecamatan" value={formData.kecamatan} onChange={handleChange} required>
                ...
                <div className="col-md-6">
                  ...
                  <select className="form-select" name="desa" value={formData.desa} onChange={handleChange} disabled={!formData.kecamatan} required>
        ...
        <div className="row justify-content-center mb-4">
          <div className="col-md-8">
            <div className="d-flex gap-2">
              ...
              <button className="btn btn-success text-nowrap" type="button" onClick={() => setShowAddModal(true)}>
                Add Order
              </button>
            </div>
          </div>
